...
export default function SiteFooter() {
  return <>
    <footer id="contact"><div className="shell footer-grid">
      ...
      <div><h3>Centres of Excellence</h3><Link href="/specialities/urology">Advanced Urology</Link><Link href="/specialities/laparoscopic-general-surgery">Laparoscopy & GI Surgery</Link><Link href="/specialities/orthopaedics-spine-and-sports-injury">Orthopaedics, Spine & Sports Injury</Link><Link href="/#centres">Oncology</Link><Link href="/specialities/internal-medicine-and-critical-care">Internal Medicine & Critical Care</Link></div>
