...
export default function SiteFooter() {
  return <>
    <footer id="contact"><div className="shell footer-grid">
      ...
      <div><h3>Centres of Excellence</h3><Link href="/#centres">Advanced Urology</Link><Link href="/#centres">Laparoscopy & GI Surgery</Link><Link href="/#centres">Orthopaedics, Spine & Sports Injury</Link><Link href="/#centres">Oncology</Link></div>
      ...
      <div><h3>Patient Care</h3><Link href="/home-healthcare">Home Healthcare</Link><Link href="/international-patients">International Patients</Link><Link href="/contact" data-quick-enquiry>Quick Enquiry</Link></div>
